...
export const BASE_TITLE = 'MCP Chat  by Machine';
export const BASE_DESCRIPTION = 'Use MCP Chat  by Machine to talk directly with 2,800+ APIs and supercharge your productivity';
